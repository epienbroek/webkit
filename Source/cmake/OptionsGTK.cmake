...
if (WIN32)
    set(ENABLE_X11_TARGET OFF CACHE BOOL "Whether to enable support for the X11 windowing target.")
    set(ENABLE_WAYLAND_TARGET OFF CACHE BOOL "Whether to enable support for the Wayland windowing target.")
    set(ENABLE_WIN32_TARGET ON CACHE BOOL "Whether to enable support for the Win32 windowing target.")
else()
    set(ENABLE_X11_TARGET ON CACHE BOOL "Whether to enable support for the X11 windowing target.")
    set(ENABLE_WAYLAND_TARGET OFF CACHE BOOL "Whether to enable support for the Wayland windowing target.")
    set(ENABLE_WIN32_TARGET OFF CACHE BOOL "Whether to enable support for the Win32 windowing target.")
endif()
